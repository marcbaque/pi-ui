...
| `e2e/startup.spec.ts` | Create | App launch, sidebar populated, empty chat state |
| `e2e/new-session.spec.ts` | Create | Dialog open, fields, start, cancel |
| `e2e/chat.spec.ts` | Create | Message send, token streaming, tool calls, auto-scroll, status |
| `e2e/abort.spec.ts` | Create | Stop button, disabled input, abort IPC, idle recovery |
| `e2e/settings.spec.ts` | Create | Modal open (button + Cmd+,), API key save, model refresh, defaults |
| `e2e/session-history.spec.ts` | Create | `test.skip` stubs for Session B |
| `e2e/tabs.spec.ts` | Create | `test.skip` stubs for Session C |
| `e2e/diff-pane.spec.ts` | Create | `test.skip` stubs for Session D |
...
**Files:**
- Create: `e2e/session-history.spec.ts`
- Create: `e2e/tabs.spec.ts`
- Create: `e2e/diff-pane.spec.ts`

- [ ] **Step 1: Create `e2e/session-history.spec.ts`**
...
- [ ] **Step 2: Create `e2e/tabs.spec.ts`**
...
- [ ] **Step 3: Create `e2e/diff-pane.spec.ts`**
